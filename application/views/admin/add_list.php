...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="pro_ref" class="form-control" id="pro_ref" placeholder="Entrer référence" value="<?= set_value('pro_ref') ?>" required>
    </div>
    <div class="form-group">
        <label for="pro_libelle">Libellé</label>
        <input type="text" name="pro_libelle" class="form-control" id="pro_libelle" placeholder="Entrer libellé" value="<?= set_value('pro_libelle') ?>" required>
    </div>
    <div class="form-group">
        <label for="pro_description">Description</label>
        <input type="text" name="pro_description" class="form-control" id="pro_description" placeholder="Entrer description" value="<?= set_value('pro_description') ?>" required>
    </div>
    <div class="form-group">
        <label for="pro_prix">Prix</label>
        <input type="text" name="pro_prix" class="form-control" id="pro_prix" placeholder="Entrer prix" value="<?= set_value('pro_prix') ?>" required>
    </div>
    <div class="form-group">
        <label for="pro_stock">Stock</label>
        <input type="text" name="pro_stock" class="form-control" id="pro_stock" placeholder="Entrer stock" value="<?= set_value('pro_stock') ?>" required>
    </div>
    <div class="form-group">
        <label for="pro_couleur">Couleur</label>
        <input type="text" name="pro_couleur" class="form-control" id="pro_couleur"  placeholder="Entrer couleur" value="<?= set_value('pro_couleur') ?>" required>
    </div>
