...
<?php } ?>
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="pro_ref" class="form-control" id="pro_ref" placeholder="Entrer référence" value="<?= $this_product->pro_ref ?>">
        </div>
        <div class="form-group">
            <label for="pro_libelle">Libellé</label>
            <input type="text" name="pro_libelle" class="form-control" id="pro_libelle" placeholder="Entrer libellé" value="<?= $this_product->pro_libelle ?>">
        </div>
        <div class="form-group">
            <label for="pro_description">Description</label>
            <textarea class="form-control" id="pro_description" rows="3" name="pro_description"><?= $this_product->pro_description ?></textarea>
        </div>
        <div class="form-group">
            <label for="pro_prix">Prix</label>
            <input type="text" name="pro_prix" class="form-control" id="pro_prix" placeholder="Entrer prix" value="<?= $this_product->pro_prix ?>">
        </div>
        <div class="form-group">
            <label for="pro_stock">Stock</label>
            <input type="text" name="pro_stock" class="form-control" id="pro_stock" placeholder="Entrer stock" value="<?= $this_product->pro_stock ?>">
        </div>
        <div class="form-group">
            <label for="pro_couleur">Couleur</label>
            <input type="text" name="pro_couleur" class="form-control" id="pro_couleur"  placeholder="Entrer couleur" value="<?= $this_product->pro_couleur ?>">
        </div>
